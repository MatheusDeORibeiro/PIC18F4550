...
# 2 "<built-in>" 2
# 1 "14-2-display-lcd.c" 2
# 22 "14-2-display-lcd.c"
...
# 22 "14-2-display-lcd.c" 2

# 1 "./configuracao_pic18f4550.h" 1
# 41 "./configuracao_pic18f4550.h"
...
# 23 "14-2-display-lcd.c" 2

# 1 "./biblioteca_lcd_2x16.h" 1
# 42 "./biblioteca_lcd_2x16.h"
void gera_atraso_us(unsigned int atraso)
{
  do
  {
    _delay(1);
...
PORTDbits.RD0 = instrucao_dado;
PORTDbits.RD1 = (unsigned char)escrita_leitura;

        if(escrita_leitura == 0)
        {
                PORTDbits.RD2 = dado>>7;
                PORTDbits.RD4 = dado>>6;
                PORTDbits.RD5 = dado>>5;
                PORTDbits.RD6 = dado>>4;

                PORTDbits.RD7 = 1;
                gera_atraso_us(2);
                PORTDbits.RD7 = 0;

                PORTDbits.RD2 = dado>>3;
                PORTDbits.RD4 = dado>>2;
                PORTDbits.RD5 = dado>>1;
                PORTDbits.RD6 = dado;
        ...
        else
        {
          ...
          gera_atraso_us(2);
                ...
                dado_entrada = PORTDbits.RD2;
                dado_entrada = (unsigned char)(dado_entrada<<1 | PORTDbits.RD4);
                dado_entrada = (unsigned char)(dado_entrada<<1 | PORTDbits.RD5);
                dado_entrada = (unsigned char)(dado_entrada<<1 | PORTDbits.RD6);

                PORTDbits.RD7 = 0;
                PORTDbits.RD7 = 1;
                gera_atraso_us(2);

                dado_entrada = (unsigned char)(dado_entrada<<1 | PORTDbits.RD2);
                dado_entrada = (unsigned char)(dado_entrada<<1 | PORTDbits.RD4);
                dado_entrada = (unsigned char)(dado_entrada<<1 | PORTDbits.RD5);
                dado_entrada = (unsigned char)(dado_entrada<<1 | PORTDbits.RD6);
...
PORTDbits.RD7 = 0;
        ...
        gera_atraso_us(20000);

        for( repeticao = 0 ; repeticao < 3 ; repeticao++ )
        {
                PORTDbits.RD2 = config_LCD[0]>>3;
                PORTDbits.RD4 = config_LCD[0]>>2;
                PORTDbits.RD5 = config_LCD[0]>>1;
                PORTDbits.RD6 = config_LCD[0];
...
PORTDbits.RD2 = config_LCD[1]>>3;
PORTDbits.RD4 = config_LCD[1]>>2;
PORTDbits.RD5 = config_LCD[1]>>1;
PORTDbits.RD6 = config_LCD[1];
...
# 24 "14-2-display-lcd.c" 2
# 35 "14-2-display-lcd.c"
