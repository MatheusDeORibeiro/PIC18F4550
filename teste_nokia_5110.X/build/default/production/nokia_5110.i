...
void Inicializa_5110(void)
{
    ...
    Envia_Instrucao(0x21);
    Envia_Instrucao(0x07);
    Envia_Instrucao(0x13);
    Envia_Instrucao(0xC0);
...
void escreve_caractere(unsigned char caractere)
{
    ...
    {
        Envia_Dado(tabela_ascii[caractere - 0x20][i]);
    }
    Envia_Dado(0x00);
}
...
void escreve_string_cor(char *string, unsigned char cor)
{
    ...
    while(*string)
    {
        ...
        {
            caractere = tabela_ascii[*string - 0x20][i];
            if(!cor) caractere = ~(caractere & 0xFF);
            Envia_Dado(caractere);
        }
        string++;
...
void desenha_linha_horizontal(unsigned char posicao_x, unsigned char posicao_y)
{
    ...
    (coordenada_x(posicao_x), coordenada_y(posicao_y));
    while(linha > 0)
    {
        Envia_Dado(0x10);
        linha--;
