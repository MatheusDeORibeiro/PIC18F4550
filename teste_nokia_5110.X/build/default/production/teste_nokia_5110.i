...
# 2 "<built-in>" 2
# 1 "teste_nokia_5110.c" 2
# 10 "teste_nokia_5110.c"
...
void desenha_reta(void);
void desenha_circulo(void);
void desenha_retangulo(void);
# 11 "teste_nokia_5110.c" 2


# 1 "./configuracao_pic18f4550.h" 1
# 20 "./configuracao_pic18f4550.h"
...
# 13 "teste_nokia_5110.c" 2
# 22 "teste_nokia_5110.c"
unsigned char opcao;
...
{
    Inic_Regs();
    Inicializa_SPI(0b00000010, 0x01, 0b10000000);
    ...
    testa_caracteres();
    _delay((unsigned long)((1000)*(20000000/4000.0)));
    (Envia_Instrucao(0x0D));
    _delay((unsigned long)((1000)*(20000000/4000.0)));
    (Envia_Instrucao(0x0C));
    _delay((unsigned long)((1000)*(20000000/4000.0)));

    limpa_display();
    _delay((unsigned long)((10)*(20000000/4000.0)));
    ((coordenada_x(0x00), coordenada_y(0x00)));
    escreve_string("teste");
    (coordenada_x(0x00), coordenada_y(0x01));
    escreve_string("(((TESTE)))");
    _delay((unsigned long)((1000)*(20000000/4000.0)));
    ...
    (coordenada_x((1 * 6) - 6), coordenada_y(1 - 1));
    escreve_caractere('A');
    _delay((unsigned long)((10)*(20000000/4000.0)));

    (coordenada_x((2 * 6) - 6), coordenada_y(2 - 1));
    escreve_caractere('A');
    _delay((unsigned long)((10)*(20000000/4000.0)));

    (coordenada_x((3 * 6) - 6), coordenada_y(3 - 1));
    escreve_caractere('A');
    _delay((unsigned long)((10)*(20000000/4000.0)));

    (coordenada_x((1 * 6) - 6), coordenada_y(4 - 1));
    escreve_string("Teste");
    _delay((unsigned long)((10)*(20000000/4000.0)));

    (coordenada_x((2 * 6) - 6), coordenada_y(5 - 1));
    escreve_string("Teste");
    _delay((unsigned long)((10)*(20000000/4000.0)));

    (coordenada_x((3 * 6) - 6), coordenada_y(6 - 1));
    escreve_string("Teste");
    _delay((unsigned long)((1000)*(20000000/4000.0)));
...
void escreve_menu(void){
    ((coordenada_x(0x00), coordenada_y(0x00)));
    (coordenada_x((6 * 6) - 6), coordenada_y(1 - 1));
    escreve_string("MENU");
    desenha_linha_horizontal(0, 1);
    (coordenada_x((1 * 6) - 6), coordenada_y(3 - 1));
    if(opcao == 3) escreve_string_cor("Opcao 1:", 0b00);
    else escreve_string("Opcao 1:");
    (coordenada_x((1 * 6) - 6), coordenada_y(4 - 1));
    if(opcao == 4) escreve_string_cor("Opcao 2:", 0b00);
    else escreve_string("Opcao 2:");
    (coordenada_x((1 * 6) - 6), coordenada_y(5 - 1));
    if(opcao == 5) escreve_string_cor("Opcao 3:", 0b00);
    else escreve_string("Opcao 3:");
    (coordenada_x((1 * 6) - 6), coordenada_y(6 - 1));
    if(opcao == 6) escreve_string_cor("Opcao 4:", 0b00);
