...
# 2 "<built-in>" 2
# 1 "14-1-display-lcd.c" 2
# 12 "14-1-display-lcd.c"
...
void main(void) {
    ...
    lcd_LD_cursor(0);
    lcd_posicao(1,6);
    imprime_string_lcd("Teste display");
    lcd_posicao(2,4);
    imprime_string_lcd("Teste display");
    while(1){
        _delay(300000);
