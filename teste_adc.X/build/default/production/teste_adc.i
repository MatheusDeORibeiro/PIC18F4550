...
void main(void)
{
    ...
    inicializa_ADC(0b01111111&0b11111101&0b11010111,
                   0b01111111&0b11001111&0b11011111&0b11110000,
                   0b11111110);
    ...
    do
    {
        ...
        PORTC = (unsigned char)resultado;
        PORTD = (unsigned char)(resultado >> 8);
